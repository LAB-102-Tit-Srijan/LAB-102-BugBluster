...
import { listenToUnreadMessageCount } from "../utils/chatHelpers";
...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = listenToUnreadMessageCount(currentUser.uid, setUnreadMessages);
    return () => unsubscribe();
  }, [currentUser?.uid]);
              ...
              <>
                ...
                <Link to="/dashboard" className="font-medium text-slate-300 hover:text-indigo-300">
                  ...
                  <Link
                    ...
                    className="relative inline-flex items-center font-medium text-slate-300 hover:text-indigo-300"
                  >
